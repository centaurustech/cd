...
<div id="blockuserinfo_hd">
<div id="header_user" style="{if $cookie->isLogged()}padding-top: 20px;{/if}">
	...
	<a href="{$link->getPageLink('my-account.php', true)}" class="header_user_info_a" title="{l s='Your Account' mod='blockuserinfo'}">{l s='Your Account' mod='blockuserinfo'}</a>
</div>
</div>
