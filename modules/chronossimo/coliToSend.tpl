...
<table class="table expedition_list" cellspacing="0" cellpadding="0">
	...
	<tbody>
		...
		<tr>
			<td><input type="hidden" name="order_id[]" value="{$order.order_id}" /><input type="checkbox" name="order_id_check[]" value="{$order.order_id}" checked="checked"/> {$order.order_id}</td>
