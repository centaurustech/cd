...
<!-- begin colLeft -->
	<div id="colLeft">
			...
			<h1>Contact Us</h1>
			<p><?php echo stripslashes(stripslashes(get_option('simplo_contact_text')))?></p>
			...
			<input type="hidden" id="receiver" name="receiver" value="<?php echo strhex(get_option('simplo_contact_email'))?>"/>
			</form>
