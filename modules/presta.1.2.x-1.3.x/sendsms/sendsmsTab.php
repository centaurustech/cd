		...
		foreach($files as $filename) {
			if (file_exists($filename)) {
				...
				if (stripos($contents, "sendsms") !== false) {
					...
					$result .= "<img src='/img/admin/warning.gif' align='absmiddle'> " . basename($filename) . "<br>" . $this->l('This file doesn\'t contain the sendsms modification') . "<br/>";
				}
				fclose($fd);
			} else {
				$result .= "<img src='/img/admin/warning.gif' align='absmiddle'> " . basename($filename) . "<br>" . $this->l('Must be copied into /override/controllers/') . "<br/>";
			}
		}
		return $result;
	}
