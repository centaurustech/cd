...
class WYSIJA_control_back_campaigns extends WYSIJA_control_back{
            ...
            if((int)$_POST['wysija']['email']['type'] === 2 && $_POST['wysija']['email']['params']['autonl']['event'] === 'new-articles') {
                ...
                $newwjdata = array(
                    ...
                    'body' => array(
                        ...
                        'block-2' => array(
                            'text' => array(
                                'value' => "<p>".__("The pigeon spread his wings to catch the wind. Even the smallest breeze could make me rise above the Northern peaks, he thought.",WYSIJA)."</p><p>".
    ...
    function viewstats(){
       ...
       $modelObjCamp->limitON=false;
        ...
        $queryCmmonStart.=" LEFT JOIN `[wysija]email_user_stat` as B on A.user_id=B.user_id";
